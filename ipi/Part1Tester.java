...
public class Part1Tester {
    ...
    public static void main(String[] args)
    {
        ...
        GeometricObject c3 = new Circle(6,"blue",true);
        GeometricObject r1 = new Rectangle();
        GeometricObject r2 = new Rectangle(2,6);        
        GeometricObject r3 = new Rectangle(3,4,"orange",true);  
        GeometricObject t1 = new Triangle();
        GeometricObject t2 = new Triangle(3,4,5);        
        GeometricObject t3 = new Triangle(4,5,6,"yellow",true); 
        ...
        ((Circle)c1).setRadius(2.5);
        c1.setColor("black");
        c1.setFilled(true);
        System.out.println("c1 = " + c1 + ", Color: " + c1.getColor() + ", Filled: " + c1.isFilled());
        
        System.out.println("c2 = Radius: " + ((Circle)c2).getRadius() + ", Diameter: " + ((Circle)c2).getDiameter() + 
        ...
        ((Rectangle)r1).setHeight(1.5);
        ((Rectangle)r1).setWidth(1.5);
        System.out.println("r1 = " + r1);
        
        System.out.println("r2 = Height: " + ((Rectangle)r2).getHeight() + ", Width: " + ((Rectangle)r2).getWidth() + 
        ...
        ((Triangle)t1).setS1(1.2);
        ((Triangle)t1).setS2(1.3);
        ((Triangle)t1).setS3(1.4);
        System.out.println("t1 = side1: " + ((Triangle)t1).getS1() + ", side2: " + ((Triangle)t1).getS2() + ", side3: " + ((Triangle)t1).getS3() + 
